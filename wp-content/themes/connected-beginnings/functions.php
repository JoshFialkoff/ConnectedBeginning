...
add_theme_support( 'genesis-menus', array( 'primary' => __( 'Primary Navigation Menu', 'beautiful' ) ) );
...
add_action( 'genesis_after_entry', 'beautiful_after_entry', 9 );
function beautiful_after_entry() {
...
genesis_register_sidebar( array(
	...
	'description' => __( 'This is the after header site banner widget area.', 'beautiful' ),
) );
genesis_register_sidebar( array(
	'id'          => 'welcome-message',
...
genesis_register_sidebar( array(
	'id'          => 'after-entry',
	'name'        => __( 'After Entry', 'beautiful' ),
	'description' => __( 'This is the after entry widget area.', 'beautiful' ),
) );
genesis_register_sidebar( array(
